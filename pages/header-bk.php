...
<body class="<?php if ($page == 'login' || $page == 'signup' || $page == 'error' || $page == 'choose'): ?>login<?php endif; ?>">
	...
	<div class="container-fluid <?php echo LAYOUT_TYPE; ?><?php if (MENU_POSITION): echo " " . MENU_POSITION; endif; ?><?php if ($page == 'login'): ?> login<?php endif; ?><?php if ($page == 'documentation' || $page == 'landing_page_1' || $page == 'landing_page_2'): ?> documentation<?php endif; ?>">
			...
			<div class="wrapper">
				...
				<ul class="topnav pull-right">
					...
					<li class="account dropdown dd-1">
					    <a data-toggle="dropdown" href="<?php echo getURL(array('my_account')); ?>" class="glyphicons logout lock"><span class="hidden-phone"><?php echo $_SESSION['n4guser']; ?></span><i></i></a>
						<ul class="dropdown-menu pull-right">
		...
		<div id="menu" class="hidden-phone hidden-print">
			...
			<!-- Sidebar Profile -->
			<span class="profile">
				<p>Welcome <a href="<?php echo getURL(array('my_account')); ?>"><?php echo $_SESSION['n4guser']; ?></a></p>
				<a class="img" href="<?php echo getURL(array('my_account')); ?>"><img src="<?php echo getAvatar($_SESSION['n4guser'],$_SESSION['n4gxhash']); ?>" alt="Avatar" /></a>
				<span>
					<ul>
			...
			<ul class="menu-0">
				...
				<?php if ($page != 'blank'): ?>
				<!-- Menu Regular Item -->
				<li class="glyphicons display active"><a href="<?php echo getURL(array('index')); ?>"><i></i><span><?php echo $translate->_('dashboard'); ?></span></a></li>
					...
					<ul class="collapse in" id="menu_components">
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_forms">
								<li class=" active"><a href="<?php echo getURL(array('form_wizards')); ?>"><span><?php echo $translate->_('Form Wizards'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('form_elements')); ?>"><span><?php echo $translate->_('form_elements'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('form_validator')); ?>"><span><?php echo $translate->_('form_validator'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('file_managers')); ?>"><span><?php echo $translate->_('file_managers'); ?></span></a></li>
							</ul>
							<span class="count">4</span>
						</li>
						...
						<li class=" active"><a href="<?php echo getURL(array('ui')); ?>"><span><?php echo $translate->_('ui_elements'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('icons')); ?>"><span><?php echo $translate->_('Icons'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('widgets')); ?>"><span><?php echo $translate->_('Widgets'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('tabs')); ?>"><span><?php echo $translate->_('Tabs'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('sliders')); ?>"><span><?php echo $translate->_('Sliders'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('charts')); ?>"><span><?php echo $translate->_('charts'); ?></span></a></li>
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_tables">
								<li class=" active"><a href="<?php echo getURL(array('tables')); ?>"><span><?php echo $translate->_('tables'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('pricing_tables')); ?>"><span><?php echo $translate->_('Pricing tables'); ?></span></a></li>
							</ul>
							<span class="count">2</span>
						</li>
						<!-- // Components Submenu Level 2 -->
						...
						<!-- Components Submenu Regular Items -->
						<li class=" active"><a href="<?php echo getURL(array('grid')); ?>"><span><?php echo $translate->_('Grid system'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('notifications')); ?>"><span><?php echo $translate->_('Notifications'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('modals')); ?>"><span><?php echo $translate->_('Modals'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('thumbnails')); ?>"><span><?php echo $translate->_('Thumbnails'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('carousels')); ?>"><span><?php echo $translate->_('Carousels'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('tour')); ?>"><span><?php echo $translate->_('Page Tour'); ?></span></a></li>
						<!-- // Components Submenu Regular Items END -->
				...
				<li class="hasSubmenu active">
					...
					<ul class="collapse in" id="menu_examples">
					
						<!-- Account Submenu Level 2 -->
						<li class="hasSubmenu active">
							<a data-toggle="collapse" href="#menu_account"><i></i><span>Account</span></a>
							<ul class="collapse in" id="menu_account">
								<li class=" active"><a href="<?php echo getURL(array('my_account_advanced')); ?>"><span><?php echo $translate->_('Advanced profile'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('my_account')); ?>"><span><?php echo $translate->_('my_account'); ?></span></a></li>
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_landings">
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_gallery">
								<li class=" active"><a href="<?php echo getURL(array('gallery_1')); ?>"><span><?php echo $translate->_('Regular'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('gallery_2')); ?>"><span><?php echo $translate->_('Masonry'); ?></span></a></li>
							</ul>
							<span class="count">2</span>
						</li>
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_maps">
								<li class=" active"><a href="<?php echo getURL(array('maps_vector')); ?>"><span><?php echo $translate->_('Vector maps'); ?></span></a></li>
								<li class=" active"><a href="<?php echo getURL(array('maps_google')); ?>"><span><?php echo $translate->_('Google maps'); ?></span></a></li>
							</ul>
							<span class="count">2</span>
						</li>
						<!-- // Examples Submenu Level 2 END -->
						...
						<li class=" active"><a href="<?php echo getURL(array('invoice')); ?>"><i></i><span><?php echo $translate->_('Invoice'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('faq')); ?>"><i></i><span><?php echo $translate->_('FAQ'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('calendar')); ?>"><i></i><span><?php echo $translate->_('calendar'); ?></span></a></li>
						...
						<li class="hasSubmenu active">
							...
							<ul class="collapse in" id="menu_ecommerce">
								<li class="hasSubmenu active">
									...
									<ul class="collapse in" id="menu_ecommerce_client">
										<li class=" active"><a href="<?php echo getURL(array('shop_client_products')); ?>"><span><?php echo $translate->_('products'); ?></span></a></li>
										<li class=" active"><a href="<?php echo getURL(array('shop_client_product')); ?>"><span><?php echo $translate->_('Product details'); ?></span></a></li>
										<li class=" active"><a href="<?php echo getURL(array('shop_client_cart')); ?>"><span><?php echo $translate->_('Shopping cart'); ?></span></a></li>
									</ul>
									<span class="count">3</span>
								</li>
								<li class="hasSubmenu active">
									<a data-toggle="collapse" href="#menu_ecommerce_admin"><i></i><span><?php echo $translate->_('Management'); ?></span></a>
									<ul class="collapse in" id="menu_ecommerce_admin">
										<li class=" active"><a href="<?php echo getURL(array('shop_admin_products')); ?>"><span><?php echo $translate->_('products'); ?></span></a></li>
										<li class=" active"><a href="<?php echo getURL(array('shop_admin_product')); ?>"><span><?php echo $translate->_('add_product'); ?></span></a></li>
									</ul>
									<span class="count">2</span>
								</li>
							</ul>
						...
						<li class=" active"><a href="<?php echo getURL(array('bookings')); ?>"><span><?php echo $translate->_('bookings'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('finances')); ?>"><span><?php echo $translate->_('finances'); ?></span></a></li>
						<li class=" active"><a href="<?php echo getURL(array('pages')); ?>"><span><?php echo $translate->_('site_pages'); ?></span></a></li>
